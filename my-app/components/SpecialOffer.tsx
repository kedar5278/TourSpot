...
export default function SpecialOffers() {
  return (
    <section className="py-14 px-4 md:px-10 bg-gray-50">
      <h2 className="text-4xl font-bold text-gray-800 mb-8">Special Offers</h2>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {offers.map((offer) => (
          <div
            key={offer.name}
            className="rounded-4xl w-80 h-80 overflow-hidden shadow-md hover:shadow-xl transition-shadow cursor-pointer group relative"
          >
            ...
            <div className="p-3 bg-white">
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <span className="text-xl text-orange-500 line-through">{offer.originalPrice}</span>
              </div>
            </div>
          </div>
        ))}

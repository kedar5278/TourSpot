  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-2xl mx-auto px-2">
        ...
        {/* Search Bar */}
        <div className="flex items-center bg-white rounded-full overflow-hidden shadow-2xl max-w-md mx-auto mb-6 sm:mb-8">
          ...
          <button
            className="bg-orange-500 hover:bg-orange-600 text-white px-2 py-3 md:px-4 text-sm font-semibold transition-colors"
            style={{ fontFamily: "'Playfair Display', serif" }}
          >
            Search
          </button>

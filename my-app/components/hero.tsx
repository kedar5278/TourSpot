    ...
    >
      ...
      <div className="relative z-10 max-w-2xl mx-auto">
        ...
        <div className="flex items-center bg-white rounded-full overflow-hidden shadow-2xl max-w-md mx-auto mb-8">
          ...
          <button className="bg-orange-500 hover:bg-orange-600 transition-colors text-white px-5 py-3 text-sm font-semibold">
            Search
          </button>
        </div>

        <button className="bg-orange-500 hover:bg-orange-600 transition-all text-white font-semibold px-8 py-3 rounded-full shadow-lg text-sm tracking-wide">
          Book Journey
        </button>
      </div>
    </section>
